...
public class ExcelExportUtil {
	 ...
	 * @return
	 */
	public static ExcelExportUtil start(String filePath, String fileWebPath, String filePrefix, List<String> fieldNames,
			List<String> fieldCodes, int flushRows)
		throws Exception {
		ExcelExportUtil excelExportSXXSSF = new ExcelExportUtil();
	 ...
	 * @return
	 */
	public void writeDatasByObject(List<?> datalist)
		throws Exception {
	 ...
	 * @throws Exception
	 */
	public void flush(int flushNum)
		throws Exception {
	...
	public static void main(String[] args)
		...
		ExcelExportUtil excelExportSXXSSF =
			ExcelExportUtil.start(filePath, "/upload/", filePrefix, fieldNames, fieldCodes, flushRows);
