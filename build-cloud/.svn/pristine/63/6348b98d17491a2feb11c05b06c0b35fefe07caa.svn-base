...
public class ValidUtils {
	public static final String mobile = "^(13|15|18|17|16)[0-9]{9}$";
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("--------------------"); System.out.println(isUInteger("-1"));
		 * System.out.println(isUInteger("0")); System.out.println(isUInteger("10"));
