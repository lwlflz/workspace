package com.build.cloud.common.suport;
...
public class WafKit {
	...
	public static String stripXSS(String value) {
		...
		if (null != value) {
			 ...
			 * scriptPattern.matcher(rlt).replaceAll(""); scriptPattern =
			 * Pattern.compile("src[\r\n]*=[\r\n]*\\\"(.*?)\\\"", Pattern.CASE_INSENSITIVE |
			 * Pattern.MULTILINE | Pattern.DOTALL); rlt = scriptPattern.matcher(rlt).replaceAll("");
			 */
